      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-5 mb-8">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
            ...
            <p className="text-3xl font-bold">{missingDocuments}</p>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-slate-400">Readiness Checklist</span>
            </div>
          ...
          <div className="mb-8 p-6 rounded-2xl bg-slate-900 border border-slate-700">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <input
                ...
                placeholder="Platform e.g. Swiggy / Uber"
                className="bg-slate-800 border border-slate-700 rounded-lg p-3"
              />
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-2xl p-6">
            <h2 className="text-xl font-bold mb-5">Income Records</h2>
          ...
          <div className="space-y-6">
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
              <h2 className="text-xl font-bold mb-5">Tax Readiness</h2>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl font-bold">Tax Reminders</h2>
              </div>
        ...
        <div className="mt-8 p-4 rounded-xl bg-slate-900 border border-slate-800">
          <p className="text-xs text-slate-500">
            RupeeMate Tax Center is a tax-readiness and
            record-organization assistant. It does not calculate or
            determine official tax liability and does not replace
